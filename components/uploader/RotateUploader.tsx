...
import {RotateFlowModal, type RotateFlowLabels} from "./RotateFlowModal";

type RotateUploaderLabels = RotateFlowLabels & {
  add: string;
};

export function RotateUploader({tool, accept, note, labels}: {
  tool: ToolAction;
  accept: string;
  note: string;
  labels: RotateUploaderLabels;
}) {
