...
import {PasswordPdfFlowModal, type PasswordPdfFlowLabels, type PasswordPdfMode} from "./PasswordPdfFlowModal";

export function PasswordPdfUploader({tool, mode, accept, note, labels}: {
  tool: ToolAction;
