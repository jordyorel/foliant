...
import {PdfToImageFlowModal, type PdfToImageFlowLabels} from "./PdfToImageFlowModal";

type PdfToImageUploaderLabels = PdfToImageFlowLabels & {
  add: string;
};

export function PdfToImageUploader({tool, accept, note, defaultFormat, labels}: {
  tool: ToolAction;
  accept: string;
  note: string;
  defaultFormat?: "jpg" | "png";
  labels: PdfToImageUploaderLabels;
}) {
