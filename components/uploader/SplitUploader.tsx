...
import {SplitFlowModal, type SplitFlowLabels} from "./SplitFlowModal";

type SplitUploaderLabels = SplitFlowLabels & {
  add: string;
};

export function SplitUploader({tool, accept, note, labels}: {
  tool: ToolAction;
  accept: string;
  note: string;
  labels: SplitUploaderLabels;
}) {
